...
sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath('.')), 'amplium'))
...
latex_documents = [
  ('index', '%s.tex' % project, '%s Documentation' % project.replace('_', '\\\\_'),
   author, 'manual'),
]
